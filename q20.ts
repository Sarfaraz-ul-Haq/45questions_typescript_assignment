...
const mountains = ["Mount Everest", "K2", "Nanga Parbat", "Broad Peak"];

const rivers = ["Yangtze River", "Ganges", "Nile", "Rhine River"];

const countries = ["Pakistan", "Saudia Arabia", "United States", "China"];
